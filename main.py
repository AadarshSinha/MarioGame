...
icon = pygame.image.load("/Users/aadarsh/Documents/VSCode/Mario_Game/images/icon.png")
pygame.display.set_icon(icon)
icon = pygame.transform.scale(icon,(100,100))

background = pygame.image.load("/Users/aadarsh/Documents/VSCode/Mario_Game/images/background.png")

base = pygame.image.load("/Users/aadarsh/Documents/VSCode/Mario_Game/images/base.png")
base = pygame.transform.scale(base,(1000,120))

start = pygame.image.load("/Users/aadarsh/Documents/VSCode/Mario_Game/images/start1.png")
start = pygame.transform.scale(start,(300,300))

pipe = pygame.image.load("/Users/aadarsh/Documents/VSCode/Mario_Game/images/pipe.png")
pipe = pygame.transform.scale(pipe,(100,300))

digits ={}
digits['numbers'] = [ 
        pygame.image.load('/Users/aadarsh/Documents/VSCode/Mario_Game/images/0.png').convert_alpha(),
        pygame.image.load('/Users/aadarsh/Documents/VSCode/Mario_Game/images/1.png').convert_alpha(),
        pygame.image.load('/Users/aadarsh/Documents/VSCode/Mario_Game/images/2.png').convert_alpha(),
        pygame.image.load('/Users/aadarsh/Documents/VSCode/Mario_Game/images/3.png').convert_alpha(),
        pygame.image.load('/Users/aadarsh/Documents/VSCode/Mario_Game/images/4.png').convert_alpha(),
        pygame.image.load('/Users/aadarsh/Documents/VSCode/Mario_Game/images/5.png').convert_alpha(),
        pygame.image.load('/Users/aadarsh/Documents/VSCode/Mario_Game/images/6.png').convert_alpha(),
        pygame.image.load('/Users/aadarsh/Documents/VSCode/Mario_Game/images/7.png').convert_alpha(),
        pygame.image.load('/Users/aadarsh/Documents/VSCode/Mario_Game/images/8.png').convert_alpha(),
        pygame.image.load('/Users/aadarsh/Documents/VSCode/Mario_Game/images/9.png').convert_alpha(),
    ]
for i in range(10):
...
def Game():
    ...
    while True:
        ...
        if collide(playerx,playery-playerchangey,pipex1-pipechangex1,pipey1+pipechangey1):
            pygame.mixer.pause()
            pygame.mixer.Sound("/Users/aadarsh/Documents/VSCode/Mario_Game/sounds/gameover.mp3").play()
            break
